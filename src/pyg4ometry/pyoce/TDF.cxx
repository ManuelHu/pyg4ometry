...
PYBIND11_MODULE(TDF, m) {
  ...
  py::class_<TDF_Attribute, opencascade::handle<TDF_Attribute>,
             Standard_Transient>(m, "TDF_Attribute")
  ...
  py::class_<TDF_Data, opencascade::handle<TDF_Data>, Standard_Transient>(
      m, "TDF_Data");
  ...
  py::class_<TDF_Label>(m, "TDF_Label")
      ...
      .def("FindAttribute",
           [](TDF_Label &label, const Standard_GUID &guid,
             ...
             auto ret = label.FindAttribute(guid, attribute);
      ...
      .def("EntryDump", [](TDF_Label &label) {
        py::scoped_ostream_redirect output;
        label.EntryDump(std::cout);
      });
  ...
  py::class_<TDF_Tool>(m, "TDF_Tool")
      ...
      .def_static("NbAttributes",
                  [](TDF_Tool &tool, const TDF_Label &label) {
