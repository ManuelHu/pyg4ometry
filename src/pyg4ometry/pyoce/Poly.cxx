...
PYBIND11_MODULE(Poly, m) {
  ...
  py::enum_<Poly_MeshPurpose>(m, "Poly_MeshPurpose")
      ...
      .value("Poly_MeshPurpose_Calculation",
             Poly_MeshPurpose::Poly_MeshPurpose_Calculation)
      .value("Poly_MeshPurpose_Presentation",
             Poly_MeshPurpose::Poly_MeshPurpose_Presentation)
      .value("Poly_MeshPurpose_Active",
             Poly_MeshPurpose::Poly_MeshPurpose_Active)
      .value("Poly_MeshPurpose_Loaded",
             Poly_MeshPurpose::Poly_MeshPurpose_Loaded)
      .value("Poly_MeshPurpose_AnyFallback",
             Poly_MeshPurpose::Poly_MeshPurpose_AnyFallback)
